...
// // ✅ Full schema aligned with public.pending_clients table
...
//   // 🆕 Add-ons and GitHub URL
//   add_ons_info: z.array(z.string()).nullable().optional(),
...
//   main_subject: z.string().nullable().optional(),
...
//     // ✅ Check if a record with same personal_email exists
...
//     // ✅ Perform UPSERT (conflict on personal_email)
...
const Payload = z.object({
  ...
  no_of_applications: z.string().default("20"),
  experience: z.string().default("0"),
  exclude_companies: z.string().default("NA"),
  
  // Optional fields with email validation
  ...
  // Timestamp fields
  client_form_fill_date: z.string().nullable().optional(),
